package net.mcreator.powerwash;
...
@Mod("powerwash")
public class PowerwashMod {
	public static final Logger LOGGER = LogManager.getLogger(PowerwashMod.class);
	public static final String MODID = "powerwash";

	public PowerwashMod(IEventBus modEventBus) {
