...
import net.mcreator.powerwash.item.model.PowerwasherWideItemModel;
...
public class PowerwasherWideItemRenderer extends GeoItemRenderer<PowerwasherWideItem> {
	public PowerwasherWideItemRenderer() {
		super(new PowerwasherWideItemModel());
	}

	@Override
	public RenderType getRenderType(PowerwasherWideItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	protected PowerwasherWideItem animatable;
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, PowerwasherWideItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, PowerwasherWideItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn,
			int color) {
	...
	@Override
	public ResourceLocation getTextureLocation(PowerwasherWideItem instance) {
